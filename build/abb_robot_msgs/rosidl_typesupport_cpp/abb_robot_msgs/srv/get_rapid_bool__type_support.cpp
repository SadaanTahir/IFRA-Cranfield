...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, abb_robot_msgs, srv, GetRAPIDBool)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<abb_robot_msgs::srv::GetRAPIDBool>();
}
